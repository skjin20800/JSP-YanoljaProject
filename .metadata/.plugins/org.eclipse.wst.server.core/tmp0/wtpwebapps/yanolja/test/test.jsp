...
<head>
    ...
    <title>야놀자</title>
     <link rel="stylesheet" href="css/index/index_style.css?ver=1"/> 
    ...
    <header>
        <div class="between yanolja ">
            ...
            <div class="yanolja__yanolja  ">
                <a href="/" class="HomeTitle_logo__14aI3">
            ...
            <div class="section1__body ">
                ...
                <div class="section1__body__main ">
                    <div class="section1__body__line ">
                        <div class="section1__line__box "><a class = "link__common" href="#">
                            ...
                            <form>
                                <div class="banner4__buttonList tbBorder mt10 ">
                                    <div><button type="button" id="banner4__button1" class="banner4__button"
                                            onclick="changeImage1A()">서울</button></button></div>
                                ...
                                <div class="banner4__imgs mt10">
                                    <div class="banner4__img "><img id="banner4_img1" src="images/banner4_seoul1.png"
                                            alt="배너" /></div>
                                    <div class="banner4__img "><img id="banner4_img2" src="images/banner4_seoul2.png"
                                            alt="배너" /></div>
                                    <div class="banner4__img "><img id="banner4_img3" src="images/banner4_seoul3.png"
                                            alt="배너" /></div>
                                    <div class="banner4__img "><img id="banner4_img4" src="images/banner4_seoul4.png"
                                            alt="배너" /></div>
                                </div>
                    ...
                    <div>
                        <form>
                            <div class="banner5__imgs mt10">
                                <div class="banner5__img "><img id="banner5_img1" src="images/banner5_leisure1.png"
                                        alt="배너" /></div>
                                <div class="banner5__img "><img id="banner5_img2" src="images/banner5_leisure2.png"
                                        alt="배너" /></div>
                                <div class="banner5__img "><img id="banner5_img3" src="images/banner5_leisure3.png"
                                        alt="배너" /></div>
                                <div class="banner5__img "><img id="banner5_img4" src="images/banner5_leisure4.png"
                                        alt="배너" /></div>
                            </div>
